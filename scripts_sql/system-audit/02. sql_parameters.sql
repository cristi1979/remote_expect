select lpad('=',10,'=') || 'Database parameters' || lpad('=',10,'=') from dual;
select v.NAME, v.VALUE, v.DESCRIPTION
 ...
 where v.NAME in
       ('processes', 'timed_statistics', 'shared_pool_size',
        ...
        'remote_login_passwordfile', 'sort_area_size', 'sga_target', 'sga_max_size', 'db_name',
        'open_cursors', 'optimizer_index_cost_adj', 'query_rewrite_enabled',
        'cursor_space_for_time', 'utl_file_dir', 'job_queue_processes',
        'job_queue_interval', 'hash_join_enabled', 'background_dump_dest',
        'user_dump_dest', 'pga_aggregate_target', 'workarea_size_policy','db_cache_size', 'filesystemio_options');
-----------------------------------------
