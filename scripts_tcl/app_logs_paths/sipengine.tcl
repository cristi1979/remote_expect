proc sipengine {{app_dir "/home/mind/mindcti/sipengine"}} {
  ...
  myhash -add ::applications_array [list $::str_app_logs $app_dir "syslog" "trace"] [list $myname "sf"]
  ...
  myhash -add ::applications_array [list $::str_app_logs $app_dir "tciapps/tcidialer/log" "output"] [list $myname]
  myhash -add ::applications_array [list $::str_app_logs $app_dir "tciapps/tcifailover/log" "output"] [list $myname]
  myhash -add ::applications_array [list $::str_app_logs $app_dir "tciapps/tcionestage/log" "output"] [list $myname]
  myhash -add ::applications_array [list $::str_app_logs $app_dir "tciapps/tcizerostage/log" "output"] [list $myname]
  myhash -add ::applications_array [list $::str_app_logs $app_dir "tciapps/tciprepaid/log" "output"] [list $myname]
