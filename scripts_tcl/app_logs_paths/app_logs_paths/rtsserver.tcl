proc rtsserver {{app_dir "/home/mind/mindcti/rts"}} {
  ...
  myhash -add ::applications_array [list $::str_app_exceptions $app_dir "log" "RTSExceptions\[0-9\]*.log"] [list $myname]
  myhash -add ::applications_array [list $::str_app_exceptions $app_dir "log" "Exceptions\[0-9\]*.log"] [list $myname]
  myhash -add ::applications_array [list $::str_app_logs $app_dir "log" "RTSInfo\[0-9\]*.log"] [list $myname]
