  ...
  gawk --re-interval -v RS="$regdate $regtime $reg\n" -v FS="\n" '{
    ...
    if (NR>1) {
      ...
      if ( ($pos != "") &&
	    ...
	    ($pos !~ "^com.mind.csr.core.CSRException: N伹ero do PIN [[:digit:]]{1,} inv疝ido.$")  &&
	    ...
	    ($pos != "com.mind.csr.core.CSRException: Cﾃｳdigo ou ID deve ser introduzido.") &&
	    ...
	    ($pos != "com.mind.csr.core.CSRException: Atﾃｩ a data deve ser maior ou igual a A partir da data.") &&
	    ...
	    ($pos != "com.mind.csr.core.CSRException: Nﾃｺmero do PIN deve ser introduzido.") &&
	    ($pos != "com.mind.csr.core.CSRException: Numele si prenumele tipului de contact exist? deja") &&
	    ($pos != "com.mind.csr.core.CSRException: O voucher nﾄバ possui serviﾃｧo para recarga, por favor, verifique o PIN.") &&
	    ...
	    ($pos !~ "^com.mind.csr.core.CSRException: Nﾃｺmero do PIN [[:print:]]{1,} jﾃ｡ existe\\!$") &&
	    ($pos !~ "^com.mind.csr.core.CSRException: Nﾄバ ﾃｩ possﾃｭvel carregar o cartﾄバ. Nﾃｺmero do PIN  [[:print:]]{1,} nﾄバ existe\\.") &&
	    ...
	    ($pos !~ "^com.mind.csr.core.CSRException: Voucher [[:print:]]{1,} estﾃ｡ inutilizﾃ｡vel.$") &&
